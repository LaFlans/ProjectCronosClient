...
// 手順(2024/05/01)
Table作成
// 1.MasterMemory関連のコードを生成(このプロジェクトのディレクトリ位置(~/Desktop/Projects/ProjectCronos)から下記を記載)
dotnet-mmgen -i ./ProjectCronos/Assets/Scripts/Schema/TableDefines -o ./ProjectCronos/Assets/MasterData/Generated/MessagePack -n "Generated"
