...
namespace ProjectCronos
{
    ...
    public class MainMenuOperateView : MonoBehaviour
    {
        ...
        public string SwitchGamepadButtonImagePath(EnumCollection.Input.INPUT_GAMEPAD_BUTTON gamepadButtonType) => gamepadButtonType switch
        {
        ...
        public Texture2D GetGamepadButtonImageTexture(EnumCollection.Input.INPUT_GAMEPAD_BUTTON gamepadButtonType)
        {
            ...
            params (EnumCollection.Input.INPUT_GAMEPAD_BUTTON, string)[] descs)
        {
            ...
            if (min > 0)
            {
                for (int i = 0; i < min; i++)
                {
                    ...
                    buttonDescriptions[i].SetUp(GetGamepadButtonImageTexture(descs[i].Item1), descs[i].Item2);
                }
            }
